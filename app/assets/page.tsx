    ...
    <div style={{ minHeight:'100vh', padding:'32px', background:'#f5f5f5' }}>
      <div style={{ maxWidth:'1000px', margin:'0 auto' }}>
        <div style={{ display:'flex', alignItems:'center', gap:'16px', marginBottom:'24px' }}>
          <a href="/dashboard" style={{ color:'#666', textDecoration:'none', fontSize:'13px' }}>Back to Dashboard</a>
          <h1 style={{ fontSize:'20px', fontWeight:600, margin:0 }}>Daftar Asset</h1>
        </div>
